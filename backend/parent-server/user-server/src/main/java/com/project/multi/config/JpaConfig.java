...
import com.project.multi.repository.custom.CustomUsersRepositoryImpl;


@Configuration
@EntityScan("com.project.multi.entities")
@EnableJpaRepositories(value = "com.project.multi.repository", repositoryBaseClass = CustomUsersRepositoryImpl.class)
